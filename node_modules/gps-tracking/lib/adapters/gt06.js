...
var adapter = function (device) {
  ...
  this.parse_data = function (data) {
    ...
    if (parts['start'] == '2a48') {
      ...
      parts['length'] = parseInt(data.length);
      console.log('length');
      console.log(parts['length']);

      // parts['finish'] = data.substr(6 + parts['length'] * 2, 4);
      parts['finish'] = data.substr(-4);
      console.log('finish');
      console.log(parts['finish']);

      parts['protocol_id'] = data.substr(5, 2);
      console.log('protocol_id');
      console.log(parts['protocol_id']);
      ...
      } else if (parts['protocol_id'] == '12') {
        parts['device_id'] = '';
        parts['data'] = data.substr(8, parts['length'] * 2);
        parts.cmd = 'ping';
        parts.action = 'ping';
      } else if (parts['protocol_id'] == '13') {
        parts['device_id'] = '';
        parts.cmd = 'heartbeat';
        parts.action = 'heartbeat';
      } else if (parts['protocol_id'] == '16' || parts['protocol_id'] == '18') {
        parts['device_id'] = '';
        parts['data'] = data.substr(8, parts['length'] * 2);
        parts.cmd = 'alert';
        parts.action = 'alert';
